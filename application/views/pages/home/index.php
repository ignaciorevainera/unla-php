...
<section class="container mb-5">
	<div class="row justify-content-center">
		<div class="col-lg-8 text-center">
			<h2 class="display-6 mb-4 fw-bold">Tu Plataforma de Confianza</h2>
			<p class="lead mb-4">Facilitamos la conexión entre fanáticos y sus eventos favoritos</p>
...
<section class="container">
	<div class="row align-items-center">
		<div class="col-lg-6">
			<h2 class="display-4 mb-4 fw-bold">Nuestra Historia</h2>
			<p class="lead mb-4">Todo comenzó con una simple idea: hacer que comprar entradas sea fácil y seguro.</p>
